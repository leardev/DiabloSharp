...
{
    [DataContract]
    internal class DetailedFollowerItemDto
    {
        [DataMember(Name = "id")]
        ...
        public DetailedFollowerItemKindDto Type { get; set; }
        ...
        public DetailedFollowerItemAttributesDto Attributes { get; set; }

        [DataMember(Name = "attributesHtml")]
        public DetailedFollowerItemAttributesDto AttributesHtml { get; set; }
        ...
        [DataMember(Name = "dye")]
        public DetailedFollowerItemDyeDto Dye { get; set; }

        [DataMember(Name = "transmog")]
        public DetailedFollowerItemTransmogDto Transmog { get; set; }

        [DataMember(Name = "set")]
        public DetailedFollowerItemSetDto Set { get; set; }

        [DataMember(Name = "gems")]
        public IEnumerable<DetailedFollowerItemGemDto> Gems { get; set; }
        ...
        public DetailedFollowerItemRecipeDto CraftedBy { get; set; }
    }
}