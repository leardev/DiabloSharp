...
namespace DiabloSharp.Tests.Endpoints
{
    ...
    public class ItemEndpointTests : EndpointTestsBase
    {
        ...
        {
            var itemIdentifier = new ItemId("corrupted-ashbringer", "Unique_Sword_2H_104_x1");
        ...
        {
            var itemIdentifier = new ItemId("star-emerald", "x1_Emerald_05");
        ...
        {
            var itemIdentifier = new ItemId("wreath-of-lightning", "Unique_Gem_004_x1");
        ...
        {
            var itemIdentifier = new ItemId("bottomless-potion-of-the-tower", "HealthPotionLegendary_01");
        ...
        {
            var itemIdentifier = new ItemId("enchanting-favor", "x1_FollowerItem_Templar_Legendary_01");
